...
let scaleDropdowns = '<select id="scaleSelector" class="dropdown" onchange="handleScale()"><option value="DIATONIC" selected>Diatonic (natural)</option><option value="PENTATONIC">Pentatonic</option><option value="HARMONIC">Harmonic</option><option value="BYZANTINE">Byzantine (double harmonic)</option><option value="MELODIC_ASC">Melodic (ascending)</option><option value="MELODIC_DESC">Melodic (descending)</option></select><select id="modeSelector" class="dropdown"><option value=0 selected>I. Ionian (major)</option><option value=1>II. Dorian</option><option value=2>III. Phrygian</option><option value=3>IV. Lydian</option><option value=4>V. Mixolydian</option><option value=5>VI. Aeolian (minor)</option><option value=6>VII. Locrian</option></select>';
